  ...
  return (
    <>
      ...
      <section id="faq" className="border-t border-white/10 bg-[#080808] px-6 py-24">
        <div className="mx-auto max-w-3xl">
          <Reveal>
            ...
            <h2 className="text-4xl font-extrabold md:text-5xl">FAQ</h2>
          </Reveal>
      ...
      <section className="border-t border-white/10 px-6 py-32 text-center">
        <Reveal>
          <div className="pointer-events-none absolute inset-x-0 top-0 h-48 bg-[radial-gradient(ellipse_60%_100%_at_50%_0%,rgba(255,87,34,0.1),transparent)]" />
      ...
      {/* ── FOOTER ── */}
      <footer className="border-t border-white/10 px-6 py-8 text-center text-sm text-white/25">
